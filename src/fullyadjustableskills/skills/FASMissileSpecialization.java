...
public class FASMissileSpecialization {
    public static float MISSILE_AMMO_BONUS = 100f;
    public static float MISSILE_SPEC_PERK_HEALTH_BONUS = 25f;
    public static float MISSILE_SPEC_ROF_BONUS = 25f;
    public static float MISSILE_SPEC_AMMO_REGEN_BONUS = 25f;
    public static float MISSILE_SPEC_DAMAGE_BONUS = 10f;
    ...
    public static class Level2 implements ShipSkillEffect {
        ...
        public String getEffectDescription(float level) {
            return "+" + (int) (MISSILE_SPEC_PERK_HEALTH_BONUS) + "% missile hit points";
        }
